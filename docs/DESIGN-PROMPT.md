...
- Duplicate check: "This number has not been seen before" or "Linked to earlier lead (Jun 2026)" with link. *(2026-09-19: always the first until repeat-lead handling is built, a future item.)*
